            ...
            rows.append(
                {
                    ...
                    "edge_start_ts_ms": detail.get("edge_start_ts_ms"),
                    "edge_finish_ts_ms": detail.get("edge_finish_ts_ms"),
                    ...
                    "accepted_indices": detail.get("accepted_indices"),
                    "correction_token_id": detail.get("correction_token_id"),
                    "acceptance_trend_slope": detail.get("acceptance_trend_slope"),
                    "retrieval": detail.get("retrieval"),
                    "previous_selected_chunk_ids": detail.get("previous_selected_chunk_ids"),
                    "selected_chunk_ids": detail.get("selected_chunk_ids"),
                    ...
                    "pipeline_hit": detail.get("pipeline_hit"),
                    "pipeline_built": detail.get("pipeline_built"),
                    "pipeline_wait_ms": detail.get("pipeline_wait_ms"),
                    "pipeline_reuse": detail.get("pipeline_reuse"),
                    ...
                    "cloud_receive_ts_ms": cloud.get("cloud_receive_ts_ms"),
                    "cloud_finish_ts_ms": cloud.get("cloud_finish_ts_ms"),
