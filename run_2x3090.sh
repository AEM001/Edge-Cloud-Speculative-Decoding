...
export VERIFY_DTYPE="${VERIFY_DTYPE:-fp16}"
export VERIFY_ATTN_IMPLEMENTATION="${VERIFY_ATTN_IMPLEMENTATION:-eager}"
export VERIFY_MODEL_PATH="${VERIFY_MODEL_PATH:-$REPO_DIR/models/Qwen3-8B}"
...
export RETRIEVE_EVERY_N_STEPS="${RETRIEVE_EVERY_N_STEPS:-4}"
