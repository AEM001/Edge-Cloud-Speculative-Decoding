...
DRAFT_GPU_MEM: float = _float("DRAFT_GPU_MEM", 0.4)
...
VERIFY_GPU_MEM: float = _float("VERIFY_GPU_MEM", 0.9)
VERIFY_MAX_LEN: int = _int("VERIFY_MAX_LEN", 4096)
VERIFY_QUANTIZATION: str = os.getenv("VERIFY_QUANTIZATION", "awq")
VERIFY_TENSOR_PARALLEL_SIZE: int = _int("VERIFY_TENSOR_PARALLEL_SIZE", 1)
